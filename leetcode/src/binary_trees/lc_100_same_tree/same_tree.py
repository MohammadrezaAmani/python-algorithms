...
def same_tree(p, q):
    def same_tree_helper(nodeP, nodeQ):
        ...
        return same_tree_helper(nodeP.left, nodeQ.left) and same_tree_helper(
...
def same_tree_concise(p, q):
    def same_tree_helper(nodeP, nodeQ):
        if nodeP is None and nodeQ is None:
            ...
            return (
                nodeP.val == nodeQ.val
                and same_tree_helper(nodeP.left, nodeQ.left)
                and same_tree_helper(nodeP.right, nodeQ.right)
            )
