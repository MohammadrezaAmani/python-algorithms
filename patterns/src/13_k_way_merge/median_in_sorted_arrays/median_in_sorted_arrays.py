...
def main():
    print("Median from lists:: " + str(merge_arrays([[3, 5, 7], [0, 6], [0, 6, 28]])))
    print("Median from lists:: " + str(merge_arrays([[2, 6, 8], [3, 6, 7], [1, 3, 4]])))
    print("Median from lists::" + str(merge_arrays([[5, 8, 9], [1, 7]])))
