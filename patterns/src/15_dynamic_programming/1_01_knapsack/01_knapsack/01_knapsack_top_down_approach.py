...
def knapsack_recursive(profits, weights, capacity, curr_index):
    ...
    if weights[curr_index] <= capacity:
        profit_1 = profits[curr_index] + knapsack_recursive(
            profits, weights, capacity - weights[curr_index], curr_index + 1
        )
...
def knapsack_recursive_dp(dp, profits, weights, capacity, curr_index):
    ...
    profit2 = knapsack_recursive_dp(dp, profits, weights, capacity, curr_index + 1)
