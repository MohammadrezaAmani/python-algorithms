...
def find_max_steal_recursive(wealth, arr_len, curr_house):
    ...
    steal_current = wealth[curr_house] + find_max_steal_recursive(
        wealth, arr_len, curr_house + 2
    )
...
def find_max_steal_recursive_dp(dp, wealth, arr_len, curr_house):
    ...
    steal_current = wealth[curr_house] + find_max_steal_recursive_dp(
        dp, wealth, arr_len, curr_house + 2
    )
